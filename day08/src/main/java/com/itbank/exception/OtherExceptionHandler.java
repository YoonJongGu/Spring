...
@ControllerAdvice(basePackageClasses = {com.itbank.controller.MemberController.class})
public class OtherExceptionHandler {
	
	@ExceptionHandler(ArithmeticException.class)
	public ModelAndView subByZero() {	// 매개변수로 예외 객체를 받지 않아도 된다 
...
//		mav.addObject("msg", "0으로 나눌 수 없습니다");
	...
	@ExceptionHandler(MyExceptionPassword.class)
	public ModelAndView myExceptionPassword(MyExceptionPassword e) {
		ModelAndView mav = new ModelAndView("error");
		mav.addObject("msg", e.getMessage());
		return mav;
	}
