...
public class MailService {
	...
	@Value("classpath:myHTML.html")
	private Resource myHTML;
...
//		body += "</div>";
		...
		try {
			mimeMessage.setFrom(new InternetAddress("edision66@naver.com"));
