...
public class AjaxController {
	...
	public int ajax03(@RequestBody HashMap<String, String> param) {
		// @RequestBody		: HTML 규칙에 상관없이 넘어오는 값을 그대로 요청으로 인식한다
		// @ResponseBody	: 함수의 반환값이 그대로 응답객체로 적용된다 (forward 하지 않는다)
...
//	@GetMapping("/checkAuthNumber")
//	public int ajax03(String email, String authNumber) {
//		System.out.println(email + ", " + authNumber);
//		int row = 0;
//		if(authNumberMap.get(email).equals(authNumber)) {
//			row = 1;
//		}
//		else {
//			row = -1;
